...
import {
  ...
  Ripple,
  SpinnerIcon
} from "./chunk-PHQLLD6Z.js";
import {
  IconBase,
  Portal,
  Tooltip
} from "./chunk-T46EYPA2.js";
import "./chunk-R2TPK5ZL.js";
import "./chunk-A7ECLLTJ.js";
import "./chunk-TWCULF2Q.js";
import {
  ComponentBase,
  useDebounce,
  useEventListener,
...
var Checkbox = React5.memo(React5.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var createInputElement = function createInputElement2() {
    ...
    return React5.createElement("input", _extends5({
      ref: inputRef
    }, inputProps));
  };
  var createBoxElement = function createBoxElement2() {
    ...
    var icon = checked ? props.icon || React5.createElement(CheckIcon, iconProps) : null;
    var checkboxIcon = IconUtils.getJSXIcon(icon, _objectSpread$4({}, iconProps), {
      props,
      checked
    });
    return React5.createElement("div", boxProps, checkboxIcon);
  };
  return React5.createElement(React5.Fragment, null, React5.createElement("div", _extends5({
    ref: elementRef
  }, rootProps), createInputElement(), createBoxElement()), hasTooltip && React5.createElement(Tooltip, _extends5({
    target: elementRef,
...
var MultiSelectHeader = React5.memo(function(props) {
  var mergeProps = useMergeProps();
  ...
  var createFilterElement = function createFilterElement2() {
    ...
    var icon2 = props.filterIcon || React5.createElement(SearchIcon, filterIconProps);
    ...
    if (props.filter) {
      ...
      var content = React5.createElement("div", filterContainerProps, React5.createElement(InputText, {
        ref: props.filterRef,
        type: "text",
        role: "searchbox",
      ...
      return React5.createElement(React5.Fragment, null, content);
    }
    return null;
  };
  ...
  var checkedIcon = props.itemCheckboxIcon || React5.createElement(CheckIcon, headerCheckboxIconProps);
  var itemCheckboxIcon = IconUtils.getJSXIcon(checkedIcon, _objectSpread$3({}, headerCheckboxIconProps), {
    selected: props.selected
  });
  var checkboxElement = props.showSelectAll && React5.createElement("div", headerCheckboxContainerProps, React5.createElement(Checkbox, {
    id: selectAllId,
    checked: props.selectAll,
    ...
    unstyled: isUnstyled()
  }), !props.filter && React5.createElement("label", headerSelectAllLabelProps, props.selectAllLabel));
  var iconProps = mergeProps({
    className: cx("closeIcon"),
    "aria-hidden": true
  }, getPTOptions("closeIcon"));
  var icon = props.closeIcon || React5.createElement(TimesIcon, iconProps);
  ...
  var closeElement = React5.createElement("button", closeButtonProps, closeIcon, React5.createElement(Ripple, null));
  var element = React5.createElement("div", headerProps, checkboxElement, filterElement, closeElement);
  if (props.template) {
    var defaultOptions = {
...
var MultiSelectItem = React5.memo(function(props) {
  var _React$useState = React5.useState(false), _React$useState2 = _slicedToArray2(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var checkboxRef = React5.useRef(null);
  var mergeProps = useMergeProps();
  var ptm = props.ptm, cx = props.cx, isUnstyled = props.isUnstyled;
  ...
  var icon = props.checkboxIcon || React5.createElement(CheckIcon, checkboxIconProps);
  ...
  return React5.createElement("li", itemProps, React5.createElement("div", checkboxContainerProps, React5.createElement(Checkbox, {
    ref: checkboxRef,
    ...
    unstyled: isUnstyled(),
    tabIndex: -1
  })), React5.createElement("span", null, content), React5.createElement(Ripple, null));
});
...
var MultiSelectPanel = React5.memo(React5.forwardRef(function(props, ref) {
  ...
  var createHeader = function createHeader2() {
    return React5.createElement(MultiSelectHeader, {
      hostName: props.hostName,
      id: props.id,
      filter: props.filter,
  ...
  var createEmptyFilter = function createEmptyFilter2() {
    ...
    return React5.createElement("li", _extends5({}, emptyMessageProps, {
  ...
  var createItem = function createItem2(option, index) {
    ...
    return React5.createElement(MultiSelectItem, {
      hostName: props.hostName,
      key: optionKey,
  ...
  var createElement6 = function createElement7() {
    ...
    return React5.createElement(CSSTransition, _extends5({
      ...
      ref
    }, panelProps), React5.createElement("span", firstHiddenElementProps), header, content, footer, React5.createElement("span", lastHiddenElementProps)));
  };
...
var MultiSelect = React5.memo(React5.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React5.useContext(PrimeReactContext);
  var props = MultiSelectBase.getProps(inProps, context);
  var _React$useState = React5.useState(null), _React$useState2 = _slicedToArray2(_React$useState, 2), focusedOptionIndex = _React$useState2[0], setFocusedOptionIndex = _React$useState2[1];
  var _React$useState3 = React5.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), clicked = _React$useState4[0], setClicked = _React$useState4[1];
  ...
  var _React$useState5 = React5.useState(-1), _React$useState6 = _slicedToArray2(_React$useState5, 2), startRangeIndex = _React$useState6[0], setStartRangeIndex = _React$useState6[1];
  var _React$useState7 = React5.useState(false), _React$useState8 = _slicedToArray2(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React5.useState(props.inline), _React$useState10 = _slicedToArray2(_React$useState9, 2), overlayVisibleState = _React$useState10[0], setOverlayVisibleState = _React$useState10[1];
  var elementRef = React5.useRef(null);
  ...
  var inputRef = React5.useRef(props.inputRef);
  var labelContainerRef = React5.useRef(null);
  var overlayRef = React5.useRef(null);
  var labelRef = React5.useRef(null);
    ...
    if (props.display === "chip" && !empty) {
      ...
      return value.map(function(val, i) {
        ...
        var icon = !props.disabled && (props.removeIcon ? IconUtils.getJSXIcon(props.removeIcon, _objectSpread2({}, iconProps), {
          props
        }) : React5.createElement(TimesCircleIcon, iconProps));
        ...
        return React5.createElement("div", _extends5({}, tokenProps, {
          key: labelKey
        }), React5.createElement("span", tokenLabelProps, label3), icon);
      });
    }
    return getLabel();
  };
  ...
  var createLabel = function createLabel2() {
    ...
    return React5.createElement("div", labelContainerProps, React5.createElement("div", labelProps, content || props.placeholder || props.emptyMessage || "empty"));
  };
  ...
  var loadingIcon = props.loadingIcon ? IconUtils.getJSXIcon(props.loadingIcon, _objectSpread2({}, triggerIconProps), {
    props
  }) : React5.createElement(SpinnerIcon, _extends5({
    spin: true
  }, triggerIconProps));
  var dropdownIcon = props.dropdownIcon ? IconUtils.getJSXIcon(props.dropdownIcon, _objectSpread2({}, triggerIconProps), {
    props
  }) : React5.createElement(ChevronDownIcon, triggerIconProps);
  var triggerIcon = React5.createElement("div", triggerProps, props.loading ? loadingIcon : dropdownIcon);
  ...
  return React5.createElement(React5.Fragment, null, React5.createElement("div", rootProps, React5.createElement("div", hiddenInputWrapperProps, React5.createElement("input", _extends5({}, inputProps, {
    readOnly: true
  }))), !props.inline && React5.createElement(React5.Fragment, null, label2, clearIcon, triggerIcon), React5.createElement(MultiSelectPanel, _extends5({
