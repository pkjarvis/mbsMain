...
import {
  ...
  TimesIcon,
  VirtualScroller
} from "./chunk-KE5NCE3A.js";
import {
  CheckIcon
} from "./chunk-4MSPUDMT.js";
import {
  InputText
...
var MultiSelect = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _React$useState5 = React.useState(-1), _React$useState6 = _slicedToArray(_React$useState5, 2), startRangeIndex = _React$useState6[0], setStartRangeIndex = _React$useState6[1];
  var _React$useState7 = React.useState(false), _React$useState8 = _slicedToArray(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React.useState(props.inline), _React$useState10 = _slicedToArray(_React$useState9, 2), overlayVisibleState = _React$useState10[0], setOverlayVisibleState = _React$useState10[1];
  var elementRef = React.useRef(null);
