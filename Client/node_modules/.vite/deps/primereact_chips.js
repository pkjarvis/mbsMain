...
import {
  TimesCircleIcon
} from "./chunk-BVUBQAIB.js";
import "./chunk-XCCYNZPY.js";
import {
  KeyFilter
} from "./chunk-RHIOIHM6.js";
import {
  Tooltip
...
var classes = {
  ...
  token: function token(_ref) {
    var focusedIndex = _ref.focusedIndex, index = _ref.index;
  ...
  root: function root(_ref3) {
    var isFilled = _ref3.isFilled, focusedState = _ref3.focusedState, disabled = _ref3.disabled, invalid = _ref3.invalid;
...
var Chips = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _React$useState3 = React.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), focusedIndex = _React$useState4[0], setFocusedIndex = _React$useState4[1];
  var _ChipsBase$setMetaDat = ChipsBase.setMetaData({
    props,
    state: {
      focused: focusedState
    }
  }), ptm = _ChipsBase$setMetaDat.ptm, cx = _ChipsBase$setMetaDat.cx, isUnstyled = _ChipsBase$setMetaDat.isUnstyled;
  ...
  var addItem = function addItem2(event, item, preventDefault) {
  ...
  var onWrapperClick = function onWrapperClick2() {
    DomHandler.focus(inputRef.current);
  };
  var onContainerKeyDown = function onContainerKeyDown2(event) {
    switch (event.code) {
      case "ArrowLeft":
        onArrowLeftKeyOn();
        break;
  ...
  var onArrowLeftKeyOn = function onArrowLeftKeyOn2() {
  ...
  var onArrowRightKeyOn = function onArrowRightKeyOn2() {
    var focusIndex = focusedIndex;
    if (inputRef.current.value.length === 0 && props.value && props.value.length > 0) {
  ...
  var onBackspaceKeyOn = function onBackspaceKeyOn2(event) {
  ...
  var updateInput = function updateInput2(event, items, preventDefault) {
    if (props.onChange) {
      props.onChange({
        originalEvent: event,
        value: items,
  ...
  var isMaxedOut = function isMaxedOut2() {
  ...
  var isRemovable = function isRemovable2(value, index) {
  ...
  var createRemoveIcon = function createRemoveIcon2(value, index) {
    if (!props.disabled && !props.readOnly && isRemovable(value, index)) {
      ...
      var icon = props.removeIcon || React.createElement(TimesCircleIcon, _extends({}, iconProps, {
  ...
  var createItem = function createItem2(value, index) {
    var content = props.itemTemplate ? props.itemTemplate(value) : value;
    var labelProps = mergeProps({
      className: cx("label")
    }, ptm("label"));
    var label = React.createElement("span", _extends({}, labelProps, {
    ...
    return React.createElement("li", _extends({}, tokenProps, {
  ...
  var createInput = function createInput2() {
    ...
    return React.createElement("li", _extends({}, inputTokenProps, {
  ...
  var createList = function createList2() {
    ...
    var containerProps = mergeProps({
      ...
      "aria-activedescendant": focusedState ? focusedOptionId() : void 0,
      "data-p-disabled": props.disabled,
      "data-p-focus": focusedState,
      onFocus: onContainerFocus,
      onBlur: onContainerBlur
    }, ptm("container"));
    return React.createElement("ul", containerProps, items, input);
  };
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", _extends({}, rootProps, {
    key: "chips"
  }), list), hasTooltip && React.createElement(Tooltip, _extends({
    target: inputRef,
...
//# sourceMappingURL=primereact_chips.js.map
