...
import {
  ChevronUpIcon
} from "./chunk-ZXRE65PC.js";
import {
  CSSTransition,
  ChevronDownIcon,
  OverlayService,
  SpinnerIcon
} from "./chunk-RDA7LKSU.js";
import {
  InputText
} from "./chunk-YWBBWTYI.js";
import {
  Ripple
} from "./chunk-KAPZIPRE.js";
import {
  IconBase
} from "./chunk-6LG5P4U3.js";
import "./chunk-3VCHR6ZI.js";
import {
  Portal,
  Tooltip
} from "./chunk-HOLCBSCA.js";
import {
  ComponentBase,
...
import {
  ...
  localeOptions,
  mask
} from "./chunk-2CMXEOOY.js";
import "./chunk-EP4LJPJC.js";
...
var CalendarIcon = React2.memo(React2.forwardRef(function(inProps, ref) {
...
var Calendar = React5.memo(React5.forwardRef(function(inProps, ref) {
  ...
  var _React$useState7 = React5.useState(props.id), _React$useState8 = _slicedToArray(_React$useState7, 2), idState = _React$useState8[0], setIdState = _React$useState8[1];
  ...
  var previousButton = React5.useRef(false);
  var nextButton = React5.useRef(false);
  var viewChangedWithKeyDown = React5.useRef(false);
  var onChangeRef = React5.useRef(null);
  var isClearClicked = React5.useRef(false);
  var _React$useState9 = React5.useState("date"), _React$useState10 = _slicedToArray(_React$useState9, 2), currentView = _React$useState10[0], setCurrentView = _React$useState10[1];
  var _React$useState11 = React5.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), currentMonth = _React$useState12[0], setCurrentMonth = _React$useState12[1];
  var _React$useState13 = React5.useState(null), _React$useState14 = _slicedToArray(_React$useState13, 2), currentYear = _React$useState14[0], setCurrentYear = _React$useState14[1];
  var _React$useState15 = React5.useState([]), _React$useState16 = _slicedToArray(_React$useState15, 2), yearOptions = _React$useState16[0], setYearOptions = _React$useState16[1];
  ...
  var createBackwardNavigator = function createBackwardNavigator2(isVisible) {
    ...
    var icon2 = props.prevIcon || React5.createElement(ChevronLeftIcon, previousIconProps);
    var backwardNavigatorIcon = IconUtils.getJSXIcon(icon2, _objectSpread2({}, previousIconProps), {
      props
    });
    ...
    return React5.createElement("button", _extends5({
      ref: previousButton
    }, previousButtonProps), backwardNavigatorIcon, React5.createElement(Ripple, null));
  };
  var createForwardNavigator = function createForwardNavigator2(isVisible) {
    ...
    var icon2 = props.nextIcon || React5.createElement(ChevronRightIcon, nextIconProps);
    var forwardNavigatorIcon = IconUtils.getJSXIcon(icon2, _objectSpread2({}, nextIconProps), {
      props
    });
    ...
    return React5.createElement("button", _extends5({
      ref: nextButton
    }, nextButtonProps), forwardNavigatorIcon, React5.createElement(Ripple, null));
  };
  ...
  var createTitleMonthElement = function createTitleMonthElement2(month2, monthIndex) {
    ...
    if (renderMonthsNavigator(monthIndex)) {
      ...
      var _content = React5.createElement("select", selectProps, displayedMonthOptions.map(function(option) {
        var optionProps = mergeProps({
          value: option.value
        }, ptm("option"));
        return React5.createElement("option", _extends5({}, optionProps, {
          key: option.label
        }), option.label);
      }));
    ...
    return currentView === "date" && React5.createElement("button", monthTitleProps, monthNames[month2]);
  };
  var createTitleYearElement = function createTitleYearElement2(metaYear) {
    ...
    if (props.yearNavigator) {
      ...
      var _content2 = React5.createElement("select", selectProps, displayedYearNames.map(function(year2) {
        var optionProps = mergeProps({
          value: year2
        }, ptm("option"));
        return React5.createElement("option", _extends5({}, optionProps, {
    ...
    return currentView !== "year" && React5.createElement("button", yearTitleProps, displayYear);
  };
  var createTitleDecadeElement = function createTitleDecadeElement2() {
    ...
    if (currentView === "year") {
      ...
      return React5.createElement("span", decadeTitleProps, props.decadeTemplate ? props.decadeTemplate(years) : React5.createElement("span", decadeTitleTextProps, "".concat(yearPickerValues()[0], " - ").concat(yearPickerValues()[yearPickerValues().length - 1])));
    }
    return null;
  };
  var createTitle = function createTitle2(monthMetaData, index) {
    ...
    return React5.createElement("div", titleProps, showMonthAfterYear ? year2 : month2, showMonthAfterYear ? month2 : year2, decade);
  };
  var createDayNames = function createDayNames2(weekDays) {
    ...
    var dayNames = weekDays.map(function(weekDay, index) {
      return React5.createElement("th", _extends5({}, tableHeaderCellProps, {
        key: "".concat(weekDay, "-").concat(index)
      }), React5.createElement("span", weekDayProps, weekDay));
    });
    if (props.showWeek) {
      ...
      var weekHeader = React5.createElement("th", _extends5({}, weekHeaderProps, {
        key: "wn"
      }), React5.createElement("span", weekLabel, localeOption("weekHeader", props.locale)));
  ...
  var createDateCellContent = function createDateCellContent2(date, className, groupIndex) {
    ...
    return React5.createElement("span", dayLabelProps, content2, selected && React5.createElement("div", {
      "aria-live": "polite",
  ...
  var createWeek = function createWeek2(weekDates, weekNumber, groupIndex) {
    var week = weekDates.map(function(date) {
      ...
      return React5.createElement("td", _extends5({}, dayProps, {
        key: date.day
      }), content2);
    });
    if (props.showWeek) {
      ...
      var weekNumberCell = React5.createElement("td", _extends5({}, weekNumberProps, {
        key: "wn" + weekNumber
      }), React5.createElement("span", weekLabelContainerProps, weekNumber));
  ...
  var createDates = function createDates2(monthMetaData, groupIndex) {
    ...
    return monthMetaData.dates.map(function(weekDates, index) {
      return React5.createElement("tr", _extends5({}, tableBodyRowProps, {
        key: index
  ...
  var createDateViewGrid = function createDateViewGrid2(monthMetaData, weekDays, groupIndex) {
    ...
    return currentView === "date" && React5.createElement("div", _extends5({}, containerProps, {
      key: UniqueComponentId("calendar_container_")
    }), React5.createElement("table", tableProps, React5.createElement("thead", tableHeaderProps, React5.createElement("tr", tableHeaderRowProps, dayNames)), React5.createElement("tbody", tableBodyProps, dates)));
  };
  var createMonth = function createMonth2(monthMetaData, index) {
    ...
    return React5.createElement("div", _extends5({}, groupProps, {
      key: monthKey
    }), React5.createElement("div", _extends5({}, headerProps, {
      key: index
  ...
  var createMonths = function createMonths2(monthsMetaData) {
    ...
    return React5.createElement("div", groupContainerProps, groups);
  };
  ...
  var createMonthYearView = function createMonthYearView2() {
    ...
    return React5.createElement(React5.Fragment, null, React5.createElement("div", groupContainerProps, React5.createElement("div", groupProps, React5.createElement("div", headerProps, backwardNavigator, React5.createElement("div", titleProps, yearElement, decade), forwardNavigator))));
  };
  ...
  var incrementIcon = IconUtils.getJSXIcon(props.incrementIcon || React5.createElement(ChevronUpIcon, incrementIconProps), _objectSpread2({}, incrementIconProps), {
    props
  });
  var decrementIcon = IconUtils.getJSXIcon(props.decrementIcon || React5.createElement(ChevronDownIcon, decrementIconProps), _objectSpread2({}, decrementIconProps), {
    props
  });
  var createHourPicker = function createHourPicker2() {
    ...
    return React5.createElement("div", hourPickerProps, React5.createElement("button", incrementButtonProps, incrementIcon, React5.createElement(Ripple, null)), React5.createElement("span", hourProps, hourDisplay), React5.createElement("button", decrementButtonProps, decrementIcon, React5.createElement(Ripple, null)));
  };
  var createMinutePicker = function createMinutePicker2() {
    ...
    return React5.createElement("div", minutePickerProps, React5.createElement("button", incrementButtonProps, incrementIcon, React5.createElement(Ripple, null)), React5.createElement("span", minuteProps, minuteDisplay), React5.createElement("button", decrementButtonProps, decrementIcon, React5.createElement(Ripple, null)));
  };
  var createSecondPicker = function createSecondPicker2() {
    if (props.showSeconds) {
      ...
      return React5.createElement("div", secondPickerProps, React5.createElement("button", incrementButtonProps, incrementIcon, React5.createElement(Ripple, null)), React5.createElement("span", secondProps, secondDisplay), React5.createElement("button", decrementButtonProps, decrementIcon, React5.createElement(Ripple, null)));
    }
    return null;
  };
  var createMiliSecondPicker = function createMiliSecondPicker2() {
    if (props.showMillisec) {
      ...
      return React5.createElement("div", millisecondPickerProps, React5.createElement("button", incrementButtonProps, incrementIcon, React5.createElement(Ripple, null)), React5.createElement("span", millisecondProps, millisecondDisplay), React5.createElement("button", decrementButtonProps, decrementIcon, React5.createElement(Ripple, null)));
    }
    return null;
  };
  var createAmPmPicker = function createAmPmPicker2() {
    if (props.hourFormat === "12") {
      ...
      return React5.createElement("div", ampmPickerProps, React5.createElement("button", incrementButtonProps, incrementIcon, React5.createElement(Ripple, null)), React5.createElement("span", ampmProps, display), React5.createElement("button", decrementButtonProps, decrementIcon, React5.createElement(Ripple, null)));
    }
    return null;
  };
  var createSeparator = function createSeparator2(separator) {
    ...
    return React5.createElement("div", separatorContainerProps, React5.createElement("span", separatorProps, separator));
  };
  var createTimePicker = function createTimePicker2() {
    if ((props.showTime || props.timeOnly) && currentView === "date") {
      ...
      return React5.createElement("div", timePickerProps, createHourPicker(), createSeparator(":"), createMinutePicker(), props.showSeconds && createSeparator(":"), createSecondPicker(), props.showMillisec && createSeparator("."), createMiliSecondPicker(), props.hourFormat === "12" && createSeparator(":"), createAmPmPicker());
    }
    return null;
  };
  ...
  var createContent = function createContent2() {
    ...
    if (props.iconPos === "left") {
      return React5.createElement(React5.Fragment, null, button, input2);
    }
    return React5.createElement(React5.Fragment, null, input2, button);
  };
  ...
  var createButtonBar = function createButtonBar2() {
    if (props.showButtonBar) {
      ...
      return React5.createElement("div", buttonbarProps, React5.createElement(Button, {
        type: "button",
  ...
  var createFooter = function createFooter2() {
    if (props.footerTemplate) {
      ...
      return React5.createElement("div", footerProps, _content3);
    }
    return null;
  };
  var createMonthPicker = function createMonthPicker2() {
    if (currentView === "month") {
      ...
      return React5.createElement("div", monthPickerProps, monthPickerValues().map(function(m, i) {
        ...
        return React5.createElement("span", _extends5({}, monthProps, {
          key: "month".concat(i + 1)
        }), m, selected && React5.createElement("div", {
          "aria-live": "polite",
          className: "p-hidden-accessible",
          "data-p-hidden-accessible": true,
          pt: ptm("hiddenMonth")
  ...
  var createYearPicker = function createYearPicker2() {
    if (currentView === "year") {
      ...
      return React5.createElement("div", yearPickerProps, yearPickerValues().map(function(y, i) {
        ...
        return React5.createElement("span", _extends5({}, yearProps, {
          key: "year".concat(i + 1)
        }), y, selected && React5.createElement("div", {
          "aria-live": "polite",
          className: "p-hidden-accessible",
          "data-p-hidden-accessible": true,
          pt: ptm("hiddenYear")
  ...
  return React5.createElement("span", _extends5({
    ref: elementRef
  }, rootProps), content, React5.createElement(CalendarPanel, {
    hostName: "Calendar",
    id: panelId,
    locale: props.locale,
    ref: overlayRef,
