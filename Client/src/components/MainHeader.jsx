...
const MainHeader = (props) => {
  return (
     ...
     <div className="theatre-container font-[Inter]">
            <Navbar para="Find Movie by moviename , Theatre by theatrename , Showtime by either moviename or theatrename" onSearch={props.onSearch} searchValue={props.searchValue} placeholderValue={props.placeholderValue}/>
