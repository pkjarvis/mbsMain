...
const DeleteBox = (props) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white shadow-2xl rounded-xl mx-auto gap-1 p-3 w-[16vw] fixed top-[20rem] left-[45rem]">
        <p className="text-xl text-pink-600 font-bold">Delete ?</p>
        ...
        <span className="flex items-center gap-3 mt-1">
            ...
            <button className="text-white bg-pink-500 rounded-xl p-2 w-[6vw] cursor-pointer" onClick={()=>handleDelete(props.id)}>Delete</button>
        </span>
    </div>
  )
}
