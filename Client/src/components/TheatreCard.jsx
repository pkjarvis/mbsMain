          ...
          <div className="right flex items-center justify-between w-[94%] ">
            <div className="right-left flex flex-col   gap-0.2">
              <span className="stream-tag flex items-center gap-2">
                <p className=" text-2xl font-semibold text-[#373737]">
                  {theatrename}
                </p>
                {status === "Active" ? (
              ...
              <span className="flex items-center gap-2">
                <img
                  ...
                  alt="LocateIcon"
                  className="w-[0.8vw] h-[0.9vw]"
                />
                <p className="font-normal text-[#373737] text-md">
                  {cityName}, {stateName}
                </p>
              </span>
              ...
              <span className="tags flex gap-2 ">
                {value?.map((item, index) => (
                  <p
                    key={index}
                    className="font-sm text-[0.6vw] border-0.4 rounded-md bg-zinc-300 w-auto p-0.5 text-center"
                  >
                    {item}
                  </p>
                ))}
