         ...
         <div className="card-container h-22 w-[100%] mx-auto p-6 mb-7">
          ...
          <div className="right flex items-center justify-between w-[92%] my-1">
            <div className="right-left flex flex-col">
              ...
              <p className="font-semibold text-xl leading-0.2">Harry Potter Season 3</p>
              <span className="flex gap-1">
                <p className='text-xs font-semibold text-zinc-700'>Cinepolis |</p>
                <p className='text-xs font-semibold text-zinc-700'>Bandra, Mumbai</p>
              </span>
