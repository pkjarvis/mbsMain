    ...
    <>
      <div className="card-container h-[90%] flex items-center border-1 border-[#E0DFDF] rounded-md overflow-hidden gap-1 my-2">
            ...
            <div className="absolute  w-[50%] h-[18vw] left-[26vw] top-[10vw] bg-white shadow-2xl z-50  flex items-center justify-evenly">
              <div className="w-[30%] h-[15vw] mt-[2vw] ">
                <Barcode
                  ...
                  lineColor="#646569" // Sets the color of the barcode lines
                  textColor="#646569"
                  fontSize={12}
                />
              </div>
              <p
                className="text-2xl font-bold absolute top-5 left-220 cursor-pointer "
                onClick={handleCancel}
              >
                X
              </p>
              <div className="w-[30%] h-[14vw] flex flex-col ml-[-12vw] mt-4">
                <p className="bg-[#EE1F7C] p-2 text-white text-2xl font-bold text-center my-oxanium-text">
                  Cinema Ticket
                </p>
                <span className="flex items-center justify-between mt-3 ">
                  <p className="text-[#848386] text-md font-semibold my-oxanium-text">
                    THEATRE:{theatreName}
                  </p>
                </span>
                ...
                <span className="flex flex-col items-start justify-center gap-1 mt-2">
                  <p className="text-2xl  text-[#EE1F7C] font-semibold my-oxanium-text">
                    {movieName}
                  </p>
                  <p className="text-[#848386] text-md font-semibold my-oxanium-text">
                    NO.{ID}
              ...
              <div className="flex flex-col items-center justify-evenly">
                <p className="text-md  text-[#848386] font-semibold my-oxanium-text">
                  STANDARD
                </p>
                <p className="text-md font-semibold text-[#848386] my-oxanium-text">
                  3D
                </p>
        ...
        <div className="left w-[6%] h-[100%] ">
          <img src={movieFile} alt="Inception" className="w-[100%] h-[100%]" />
        </div>
        <div className="right flex items-center justify-between w-[92%] p-1">
          <div className="rights-left flex flex-col py-1 justify-evenly gap-1">
            ...
            <p className="text-xs text-[#3B3B3B]">{theatreAddress}</p>
